...
END) AS Dan_Yes,
(CASE WHEN Genre='Action' AND Rotten_Tomatoes_Ratings>=70 OR Genre='Drama' AND Rotten_Tomatoes_Ratings>=70 OR Genre='Comedy'AND Year_of_release='2007' OR Genre='Romance' AND Year_of_release='2007' OR Genre='Horror' AND Audience_Ratings>=80 OR Genre='Thriller' AND Audience_Ratings>=80 OR Genre='Adventure' THEN 'Skyler_approved' END) AS Skyler_Yes,

(CASE WHEN Genre='Comedy' AND Rotten_Tomatoes_Ratings>=65 OR Genre='Horror' AND Rotten_Tomatoes_Ratings>=65 OR Genre='Drama' AND Year_of_release='2011' OR Genre='Thriller' AND Audience_Ratings>=60 OR Genre='Action' AND Audience_Ratings>=60 OR Genre='Romance' AND Budget_million>=50 OR Genre='Adventure' AND Year_of_release='2009' OR Genre='Adventure' AND Year_of_release='2010' THEN 'Liz_approved' END) AS Liz_Yes
